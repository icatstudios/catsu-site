  ...
  return (
    <div ref={wrapperRef} className="relative">
      <button
        ...
        className={`inline-flex items-center gap-2 rounded-lg border border-[var(--hairline)] bg-white/[0.03] px-2.5 py-1.5 text-xs font-semibold text-foreground backdrop-blur transition-colors hover:border-[var(--gold)] ${
      ...
      {open && (
        <div
          ...
          className="absolute end-0 mt-2 w-60 max-h-[60vh] overflow-y-auto rounded-xl border border-[var(--hairline)] bg-[#0d0a18]/95 backdrop-blur-md z-50 p-1.5"
          style={{
            boxShadow:
              "0 20px 50px rgba(0,0,0,0.6), 0 0 30px rgba(106,63,208,0.2), inset 0 1px 0 rgba(255,255,255,0.05)",
          }}
        >
